...
<html>
	<jsp:include page="page_head.jsp">
		<jsp:param name="pageTitle" value="Add Product to Order" />
	</jsp:include>
<body>
<div class="container">
	...
	<div class="row">
		<div class="col text-center">
			<h3>Add product to Order ID: ${order.orderId}</h3>
		</div>
	</div>
		...
		<div class="col">
			<form action="add_product_to_order" method="post">
				<div class="form-group row">
					<label class="col-sm-4 col-form-label">Select a product:</label>
					<div class="col-sm-8">
